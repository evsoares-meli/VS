...
#Functions and Vars
desc = ['VLAN_MGMT','VLAN_CCTV-MON','VLAN_WIFI','VLAN_PRINTER','VLAN_HANDHELD','VLAN_OPERATOR','VLAN_CLOCK','VLAN_IS','VLAN_ACCESSCONTROL','VLAN_CORP','VLAN_CAMERAS','PRIMARY_LINK','SECONDARY_LINK']
